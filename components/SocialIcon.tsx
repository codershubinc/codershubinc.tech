...
// Export individual social link components
export function GitHubLink({ size = 'md', color = 'gray', hoverEffect = true, className }: Omit<SocialIconProps, 'name'>) {
    return (
        <Link
        ...
        >
            <SocialIcon name="github" size={size} color={color} hoverEffect={hoverEffect} />
        </Link>
    );
}

export function TwitterLink({ size = 'md', color = 'gray', hoverEffect = true, className }: Omit<SocialIconProps, 'name'>) {
    return (
        <Link
            ...
            className={className || "inline-block"}
        >
            <SocialIcon name="twitter" size={size} color={color} hoverEffect={hoverEffect} />
        </Link>
    );
}

export function PortfolioLink({ size = 'md', color = 'gray', hoverEffect = true, className }: Omit<SocialIconProps, 'name'>) {
    return (
        <Link
            ...
            className={className || "inline-block"}
        >
            <SocialIcon name="portfolio" size={size} color={color} hoverEffect={hoverEffect} />
        </Link>
    );
}

export function EmailLink({ size = 'md', color = 'gray', hoverEffect = true, className }: Omit<SocialIconProps, 'name'>) {
    return (
        <Link
            ...
            className={className || "inline-block"}
        >
            <SocialIcon name="email" size={size} color={color} hoverEffect={hoverEffect} />
        </Link>
    );
}