...
export default async function TodayContributionsBadge() {
    ...
    return (
        <div className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-gradient-to-r from-zinc-800/80 to-zinc-900/80 border border-white/10 text-xs font-mono font-bold text-zinc-300 shadow-md backdrop-blur-sm">
