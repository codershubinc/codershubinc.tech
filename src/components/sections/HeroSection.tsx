...
export function HeroSection() {
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center px-6 py-8 lg:px-8 overflow-hidden bg-background">
            {/* Background Elements */}
            ...
            <div className="relative mx-auto max-w-5xl text-center w-full">
                ...
                <div className="flex flex-col items-center mb-6 sm:mb-8">
                    ...
                    <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl xl:text-8xl mb-2">
                ...
                <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-semibold text-foreground mb-6 sm:mb-8 leading-tight">
                    Smart,
                ...
                <p className="text-lg sm:text-xl lg:text-2xl text-muted-foreground mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed font-light">
                    A curated collection of practical, open-source projects designed to solve
                    <span className="font-medium text-foreground"> real-world developer problems</span>
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 sm:mb-16">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold text-foreground bg-background/80 backdrop-blur-sm border border-border rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:bg-background w-full sm:w-auto"
                    >
