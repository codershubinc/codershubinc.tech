        ...
        <div className="hidden lg:flex items-center gap-2.5">
            ...
            >
                <div className="relative overflow-hidden flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-linear-to-br from-black/70 to-[#0b1118]/80 border border-white/10 group-hover:border-[#007acc]/45 transition-colors duration-300 font-mono text-xs whitespace-nowrap">
                    ...
                    <span className="text-zinc-500 group-hover:text-zinc-300 transition-colors relative z-10 whitespace-nowrap">--cult-members</span>
                    <span className="text-white font-bold tabular-nums relative z-10 whitespace-nowrap">{compactNumber(profile.followers)}</span>
                </div>
            </a>
            ...
            >
                <div className="relative overflow-hidden flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-linear-to-br from-black/70 to-[#0b1118]/80 border border-white/10 group-hover:border-[#007acc]/45 transition-colors duration-300 font-mono text-xs whitespace-nowrap">
                    ...
                    <span className="text-zinc-500 group-hover:text-zinc-300 transition-colors relative z-10 whitespace-nowrap">--public.repos</span>
                    <span className="text-white font-bold tabular-nums relative z-10 whitespace-nowrap">{compactNumber(profile.repos)}</span>
                </div>
            </a>
        </div>
    );
