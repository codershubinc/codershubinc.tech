        ...
        >
            ...
            >
                <div>
                    ...
                    <p className="text-[#555] font-mono text-sm mt-2">{"// the human behind the terminal"}</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 relative z-10">
                ...
                >
                    ...
                    <div className="bg-linear-to-br from-[#111]/80 to-[#0a0a0a]/80 border border-white/8 rounded-2xl p-6 sm:p-8 space-y-5 backdrop-blur-sm">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                <p className="text-white font-bold font-mono text-lg leading-none">Swapnil Ingle</p>
                                <p className="text-[#555] font-mono text-xs mt-0.5">Backend Engineer · Systems Enthusiast</p>
                            </div>
                        </div>

                        <div className="space-y-4 text-[#999] leading-relaxed text-sm sm:text-base border-t border-white/5 pt-5">
                            <p>
                                Hi, I&apos;m a <span className="text-white font-medium">2nd-year B.Tech AIML student</span> based in{" "}
                                <span className="inline-flex items-center gap-1 text-white font-medium">
                                    <MapPin size={13} className="text-[#007acc]" />Panvel, Mumbai
                                </span>.
                                While on campus I live in the terminal — building tools, breaking configs, and shipping side projects.
                            </p>
                            <p>
                                I spend my nights digging into <span className="text-white font-medium">low-level systems</span>,
                                customizing <span className="text-[#1793D1] font-medium">Arch Linux</span>, writing
                                high-throughput services in <span className="text-[#00ADD8] font-medium">Go</span>, and
                                occasionally touching the metal with <span className="text-[#CE422B] font-medium">Rust</span>.
                            </p>
                            <p>
                                My goal: bridge the gap between polished web products and raw system performance.
                                I believe the <span className="text-white font-medium">best software</span> lives where
                                both worlds meet.
                            </p>
                        </div>
                    ...
                    >
                        {stats.map((s) => (
                            ...
                            >
                                ...
                                <span className="text-white font-mono font-bold text-lg leading-none">{s.value}</span>
                    ...
                    <div className="flex flex-wrap gap-3">
                        ...
                        >
                            <Linkedin size={14} className="group-hover:text-[#0A66C2] transition-colors" />
                ...
                <motion.div
                    ...
                    whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.65, delay: 0.1, ease: [0.22, 0.68, 0, 1.1] }}
                >
                    {/* Tech stack */}
                    ...
                    <div className="bg-linear-to-br from-[#111]/80 to-[#0a0a0a]/80 border border-white/8 rounded-2xl p-6 backdrop-blur-sm">
                        ...
                        <ul className="space-y-3 text-sm">
                            {[
                                ...
                                <li key={row.label} className="flex justify-between items-center group border-b border-white/4 pb-2 last:border-0 last:pb-0">
