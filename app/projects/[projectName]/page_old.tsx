...
import { getAllProjectIds, getProjectById, detailedProjects, type ProjectData } from "@/data";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    if (!project) {
        return {
            title: "Project Not Found - CodersHub Inc",
            description: "The requested project could not be found.",
        };
    }

    return {
        title: `${project.name} - CodersHub Inc`,
        description: project.description,
        keywords: [project.name, ...project.techStack, "developer tools", "open source"],
        openGraph: {
            title: `${project.name} - CodersHub Inc`,
            description: project.description,
            url: `https://codershubinc.tech/projects/${projectName}`,
            type: "website",
        },
    };
}
            ...
            <div className="lg:hidden mb-6">
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-4">
                    ...
                    <select
                        ...
                        onChange={(e) => {
                            if (e.target.value !== currentProject) {
